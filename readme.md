...
Com eles, você pode:
- Instalar e configurar Docker, Docker compose e Nginx
- Configurar chaves SSH e seu arquivo de config
- atualizar pacotes instalados no sistema e remover os não utilizados
- Interagir com a CLI da Heroku para automatizar ações
